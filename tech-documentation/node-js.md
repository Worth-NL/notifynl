...
description: >-
  ...
  Node.js client to send emails, text messages or letters.
icon: node
---
...
If the request is not successful, the promise fails with an `err`. To learn more about error structure, go to [Errors section](node-js.md#errors).
...
Find out how to [reduce the risk of malicious content injection in placeholders](node-js.md#reducing-the-risk-of-malicious-content-injection-in-placeholders).
...
* [email status](node-js.md#email-status-descriptions)
* [text message status](node-js.md#text-message-status-descriptions)
* [letter status](node-js.md#letter-status-descriptions)
* [precompiled letter status](node-js.md#precompiled-letter-status-descriptions)
...
* check the response to the [original notification method call](node-js.md#get-the-data-for-one-message)
* [sign in to NotifyNL](https://admin.notifynl.nl/sign-in) and go to the **API integration** page
...
* [various schema validation errors](node-js.md#schema-validation-errors), for example when you forget to pass in an argument, or pass in an argument of a wrong type.
* errors that are not related to generating a preview template, but instead are related to things like authentication and rate limits. You can find a list of these errors [in General errors](node-js.md#general-errors)
...
* [send a message](node-js.md#send-a-message)
* [get message data](node-js.md#get-message-data)
* [get a template](node-js.md#get-a-template)
* [get received text messages](node-js.md#get-received-text-messages)
