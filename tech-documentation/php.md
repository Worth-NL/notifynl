---
description: >-
  This documentation is for developers interested in using the GOV.UK Notify PHP
...
If the request is not successful, the client returns an error. To learn more about error structure, go to [Errors section](php.md#errors).
...
Find out how to [reduce the risk of malicious content injection in placeholders](php.md#reducing-the-risk-of-malicious-content-injection-in-placeholders).
...
If you send subscription emails you must let recipients opt out of receiving themThe one-click. Read our Using Notify page for more information about [unsubscribe links](../using-notifynl/using-notifynl/unsubscribe-links.md).
...
NotifyNL lets you [personalise messages](../using-notifynl/using-notifynl/personalisation.md) using placeholders.
...
The precompiled letter must be a PDF file which meets [the GOV.UK Notify letter specification](https://www.notifications.service.gov.uk/using-notify/guidance/letter-specification). The method sends the contents of the file to NotifyNL.
...
* check the response to the [original notification method call](https://docs.notifications.service.gov.uk/php.html#response)
...
* [email status](php.md#email-status-descriptions)
* [text message status](php.md#text-message-status-descriptions)
* [letter status](php.md#letter-status-description)
* [precompiled letter status](php.md#precompiled-letter-status-descriptions)
...
* check the response to the [original notification method call](https://docs.notifications.service.gov.uk/php.html#get-the-status-of-one-message-response)
* [sign in to NotifyNL](https://admin.notifynl.nl/sign-in) and go to the **API integration** page
...
* [various schema validation errors](php.md#schema-validation-errors), for example when you forget to pass in an argument, or pass in an argument of a wrong type.
* errors that are not related to generating a preview template, but instead are related to things like authentication and rate limits. You can find a list of these errors [in General errors](php.md#general-errors)
...
* [send a message](php.md#send-a-message)
* [get message data](php.md#get-message-data)
* [get a template](php.md#get-a-template)
* [get received text messages](php.md#get-received-text-messages)
