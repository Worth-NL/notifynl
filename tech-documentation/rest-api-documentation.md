---
description: >-
  This documentation is for developers interested in using the GOV.UK Notify API
  to send emails, text messages or letters.
icon: brackets-curly
---
...
Developers can also use [our OpenAPI file](/broken/pages/yQmnZEoeX3fiPahYDZ6s) with tools such as [Swagger](https://swagger.io/) and [Redoc](https://github.com/Redocly/redoc) to assist with using the REST API. You cannot use Swagger Editor to make test API requests.
...
The authorisation header is an [API key](../misc/api-keys.md) that is encoded using [JSON Web Tokens](https://jwt.io/). You must include an authorisation header.
...
That secret key forms a part of your [API key](../misc/api-keys.md), which follows the format `{key_name}-{iss-uuid}-{secret-key-uuid}`.
...
If the request is not successful, the API returns `json` containing the relevant error code. To learn more about error structure, go to [Errors section](https://docs.notifications.service.gov.uk/rest-api.html#errors).
...
* [various schema validation errors](rest-api-documentation.md#schema-validation-errors), for example when you forget to pass in an argument, or pass in an argument of a wrong type.
* errors that are not related to sending a text message, but instead are related to things like authentication and rate limits. You can find a list of these errors [in General errors](rest-api-documentation.md#general-errors).
...
Find out how to [reduce the risk of malicious content injection in placeholders](https://docs.notifications.service.gov.uk/rest-api.html#reducing-the-risk-of-malicious-content-injection-in-placeholders).
...
If the request is not successful, the API returns `json` containing the relevant error code. To learn more about error structure, go to [Errors section](rest-api-documentation.md#errors).
...
* [various schema validation errors](https://docs.notifications.service.gov.uk/rest-api.html#schema-validation-errors), for example when you forget to pass in an argument, or pass in an argument of a wrong type.
* errors about a file you try to send via email. You can find a list of these errors at the end of [Send a file by email](https://docs.notifications.service.gov.uk/rest-api.html#send-a-file-by-email)
* errors that are not related to sending an email, but instead are related to things like authentication and rate limits. You can find a list of these errors [in General errors](https://docs.notifications.service.gov.uk/rest-api.html#general-errors)
...
| `Send files by email has not been set up - add contact details for your service at https://www.notifications.service.gov.uk/services/(SERVICE ID)/service-settings/send-files-by-email` | See how to [add contact details to the file download page](https://docs.notifications.service.gov.uk/rest-api.html#add-contact-details-to-the-file-download-page) |
...
* other errors related to [sending an email](https://docs.notifications.service.gov.uk/rest-api.html#send-an-email).
* [various schema validation errors](https://docs.notifications.service.gov.uk/rest-api.html#schema-validation-errors), for example when you forget to pass in an argument, or pass in an argument of a wrong type.
* errors that are not related to sending an email, but instead are related to things like authentication and rate limits. You can find a list of these errors [in General errors](https://docs.notifications.service.gov.uk/rest-api.html#general-errors)
...
| ------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **ValidationError (status code 400)**                                                                         |                                                                                                                                                                                                          |
| `personalisation address_line_1 is a required property`                                                       | Ensure that your template has a field for the first line of the address, check [personalisation](https://docs.notifications.service.gov.uk/rest-api.html#personalisation-required) for more information. |
...
| `Cannot send letters with a team api key`                                                                     | Use the correct type of [API key](https://docs.notifications.service.gov.uk/rest-api.html#api-keys).                                                                                                     |
...
* other errors related to [sending an letter](https://docs.notifications.service.gov.uk/rest-api.html#send-a-letter).
* [various schema validation errors](https://docs.notifications.service.gov.uk/rest-api.html#schema-validation-errors), for example when you forget to pass in an argument, or pass in an argument of a wrong type.
* errors that are not related to sending a letter, but instead are related to things like authentication and rate limits. You can find a list of these errors [in General errors](https://docs.notifications.service.gov.uk/rest-api.html#general-errors)
...
* check the response to the [original notification method call](https://docs.notifications.service.gov.uk/rest-api.html#get-the-status-of-one-message-response).
...
* [various schema validation errors](rest-api-documentation.md#schema-validation-errors), for example when you forget to pass in an argument, or pass in an argument of a wrong type.
* errors that are not related to getting the status of a message, but instead are related to things like authentication and rate limits. You can find a list of these errors [in General errors](rest-api-documentation.md#general-errors)
...
* [`template_type`](https://docs.notifications.service.gov.uk/rest-api.html#template-type-optional)
* [`status`](https://docs.notifications.service.gov.uk/rest-api.html#status-optional)
* [`reference`](https://docs.notifications.service.gov.uk/rest-api.html#get-the-status-of-multiple-messages-arguments-reference-optional)
* [`older_than`](https://docs.notifications.service.gov.uk/rest-api.html#older-than-optional)
* [`include_jobs`](https://docs.notifications.service.gov.uk/rest-api.html#include-jobs-optional)
...
* [email status](rest-api-documentation.md#email-status-descriptions)
* [text message status](rest-api-documentation.md#text-message-status-descriptions)
* [letter status](rest-api-documentation.md#letter-status-descriptions)
* [precompiled letter status](rest-api-documentation.md#precompiled-letter-status-descriptions)
...
| `‘Apple’ is not one of [sms, email, letter]`                                                                                                                                                                                                               | Change the [template\_type argument](https://docs.notifications.service.gov.uk/rest-api.html#template-type-optional). |

In addition to the above, you may also encounter:

* [various schema validation errors](https://docs.notifications.service.gov.uk/rest-api.html#schema-validation-errors), for example when you forget to pass in an argument, or pass in an argument of a wrong type.
* errors that are not related to getting the status of messages, but instead are related to things like authentication and rate limits. You can find a list of these errors [in General errors](https://docs.notifications.service.gov.uk/rest-api.html#general-errors)
...
* check the response to the [original notification POST call](https://docs.notifications.service.gov.uk/rest-api.html#response)
* [sign in to NotifyNL](https://admin.notifynl.nl/sign-in) and go to the **API integration** page
...
* [various schema validation errors](https://docs.notifications.service.gov.uk/rest-api.html#schema-validation-errors), for example when you forget to pass in an argument, or pass in an argument of a wrong type.
* errors that are not related to getting a PDF for a letter, but instead are related to things like authentication and rate limits. You can find a list of these errors [in General errors](https://docs.notifications.service.gov.uk/rest-api.html#general-errors)
...
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| **NoResultFound (status code 404)** |                                                                                                                                        |
| `No Result Found`                   | Check your [template ID](https://docs.notifications.service.gov.uk/rest-api.html#get-a-template-by-id-arguments-template-id-required). |

In addition to the above, you may also encounter:

* [various schema validation errors](https://docs.notifications.service.gov.uk/rest-api.html#schema-validation-errors), for example when you forget to pass in an argument, or pass in an argument of a wrong type.
* errors that are not related to getting a template, but instead are related to things like authentication and rate limits. You can find a list of these errors [in General errors](https://docs.notifications.service.gov.uk/rest-api.html#general-errors)
...
* [various schema validation errors](https://docs.notifications.service.gov.uk/rest-api.html#schema-validation-errors), for example when you forget to pass in an argument, or pass in an argument of a wrong type.
* errors that are not related to generating a preview template, but instead are related to things like authentication and rate limits. You can find a list of these errors [in General errors](https://docs.notifications.service.gov.uk/rest-api.html#general-errors)

## Get received text messages

This API call returns one page of up to 250 received text messages. You can get either the most recent messages, or get older messages by specifying a particular notification ID in the older\_than query parameter.
...
You can specify which text messages to receive by inputting the ID of a received text message into the [`older_than`](https://docs.notifications.service.gov.uk/rest-api.html#get-a-page-of-received-text-messages-query-parameters-older-than-optional) argument.
...
| `Invalid token: API key not found`                                                                                      | Use the correct API key. Refer to [API keys](https://docs.notifications.service.gov.uk/rest-api.html#api-keys) for more information |
| **RateLimitError (status code 429)**                                                                                    |                                                                                                                                     |
| `Exceeded rate limit for key type <team/test/live> of 3000/<custom limit> requests per 60 seconds`                      | Refer to [API rate limits](https://docs.notifications.service.gov.uk/rest-api.html#rate-limits) for more information                |
| **TooManyRequestsError (status code 429)**                                                                              |                                                                                                                                     |
| `Exceeded send limits (<sms/email/letter/international_sms>: <LIMIT SIZE>) for today`                                   | Refer to [service limits](https://docs.notifications.service.gov.uk/rest-api.html#daily-limits) for the limit size                  |
...
* [send a message](rest-api-documentation.md#send-a-message)
* [get message data](rest-api-documentation.md#get-message-data)
* [get a template](rest-api-documentation.md#get-a-template)
* [get received text messages](rest-api-documentation.md#get-received-text-messages)
